class Unit {
    constructor(num){
        ...
        this.unit = this.makeUnit(num);
        this.dragElement(this.unit);
    ...
    dragElement(elmnt) {
        ...
        function closeDragElement() {
            elmnt.style.top = Math.round( (elmnt.offsetTop - pos2)/100)* 100 + "px";
            elmnt.style.left = Math.round((elmnt.offsetLeft - pos1)/100)* 100 + "px";
